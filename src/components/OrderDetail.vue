...
//     })
//     // window.open(`http://localhost:5173/alipay/pay?subject=123456&traceNo=112345&totalAmount=100`)
  ...
  <div style="display: flex; flex-direction: column">
    ...
    <div style="margin-top: 2vh" v-if="orderDetail.data && orderDetail.data.status === '等待支付'">
      <div style="float:right;">
        ...
        <!-- <el-button type="primary" @click="aliPay(id ?? -1)">
          支付宝支付
        </el-button> -->
      </div>
    </div>
